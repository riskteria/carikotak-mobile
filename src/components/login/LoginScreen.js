			...
			<ScrollView style={styles.container}>
				...
				<View>
					...
					<Item floatingLabel style={ StyleSheet.flatten(styles.inputGroup) }>
						...
						<Input onChangeText={username => this.setState({ user: Object.assign({}, this.state.user, { username }) })} />
					</Item>

					<Item floatingLabel style={ StyleSheet.flatten(styles.inputGroup) }>
						<Label style={ StyleSheet.flatten(styles.lightColor) }>KATA SANDI</Label>
						<Input onChangeText={password => this.setState({ user: Object.assign({}, this.state.user, { password }) })} secureTextEntry />
					</Item>
